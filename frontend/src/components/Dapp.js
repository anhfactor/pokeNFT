...
export class Dapp extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <Tabs>
        <TabList>
          <Tab><img src={tab1} height="32" width="32"/> Claim pokemon cards </Tab>
          <Tab><img src={tab2} height="32" width="32"/> Edit profile</Tab>
        </TabList>
        <TabPanel>
        <div className="row justify-content-md-center d-flex align-items-center">
          {/* <div>
            Your DID stored in Local Storage is: {this.state.userDID}
          </div> */}
  ...
  async _saveProfile() {
    ...
    const streamId = this.state.userDID.split(":")[2]
    const stream = await ceramic.loadStream("kjzl6cwe1jw148mmmwz6ori8ilbv8ru71l2nmadmmfob8j4wkkmuzraqdaoqsoz")
    // const schema = {
    ...
    //   ]
    // }
    const content = {'name' : 'anh', 'gender' : 'male', 'email' : 'b'}
    const metadata = {
